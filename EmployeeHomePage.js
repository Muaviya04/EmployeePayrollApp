...
const createInnerHtml = () => {
    ...
    <td>
        <img id="${empPayrollData._id}" onclick="remove(this)" alt="delete" src="./assets/icons/delete-black-18dp.svg" width="30px">
        <a href="EmployeePayroll.html" onclick="update(this)"><img id="${empPayrollData._id}" onclick="update(this)" alt="edit" src="./assets/icons/8.jpg" width="30px"></a>
    </td>
</tr>
`;
    }
